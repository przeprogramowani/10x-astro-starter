...
export default function GeneratedCardsList({ suggestedCards, onSave, isSaving }: GeneratedCardsListProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <SelectionControls onSelectAll={selectAll} onDeselectAll={deselectAll} />
